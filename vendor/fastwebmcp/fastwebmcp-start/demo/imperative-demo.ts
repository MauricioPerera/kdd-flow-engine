// Same demo as the monorepo's examples/imperative-demo.ts, EXCEPT this imports from
// the real published package, not the local src_ts/ -- this is what an external
// consumer's code actually looks like.
import { z } from 'zod';
import { registerTool, supportsWebMcp } from 'fastwebmcp';
