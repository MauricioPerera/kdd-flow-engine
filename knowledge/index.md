...
- [MCP Ecosystem & Multi-Agent Orchestration in Workflows](./mcp_multiagent_orchestration.md) — Orquestacion de clientes y servidores MCP y delegacion entre subagentes.
